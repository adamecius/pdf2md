...
- 2026-04-25 15:00 UTC: Use `backend_catalog.yaml` backend IDs (`paddleocr_vl`) with explicit `registry_name` mapping (`paddleocr-vl`) to keep script contracts stable while preserving current registry naming.
