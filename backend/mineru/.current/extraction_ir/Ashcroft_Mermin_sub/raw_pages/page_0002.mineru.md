...
For some time people were led into diffcult but irrelevant problems connected with the proper aig o n electron  in eac colion.S iteral n iteretation o Figure 1. is eu to be avoided.

8 See Problem 1.

Given the free and independent electron approximation, this is the only possible mechanism left.