...
class TestEntityEnums:
    def test_entity_type_values_match_specification(self):
        assert {e.value for e in EntityType} == {"document_title","chapter","section","toc_entry","page_number","header","footer","footnote","equation","theorem","definition","corollary","proof","example","figure","table","caption","reference_section","reference_item","bibliography_marker","index_section","index_entry","glossary_section","glossary_entry","unknown"}
