...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('--root',default='groundtruth/corpus/latex'); ap.add_argument('--batch',default='batch_001'); ap.add_argument('--verbose',action='store_true'); a=ap.parse_args()
