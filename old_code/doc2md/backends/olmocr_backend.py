"""Optional OlmOcrBackend backend stub for offline/local experimentation."""
...
class OlmOcrBackend(ExtractionBackend):
    """Optional backend intended for offline/local experimentation only."""

    name = "olmocr"

    def available(self) -> bool:
        return all(importlib.util.find_spec(dep) is not None for dep in ('olmocr',))
