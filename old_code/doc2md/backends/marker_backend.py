"""Optional MarkerBackend backend stub for offline/local experimentation."""
...
class MarkerBackend(ExtractionBackend):
    """Optional backend intended for offline/local experimentation only."""

    name = "marker"

    def available(self) -> bool:
        return all(importlib.util.find_spec(dep) is not None for dep in ('marker',))
