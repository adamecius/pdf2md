"""Optional DotsOcrBackend backend stub for offline/local experimentation."""
...
class DotsOcrBackend(ExtractionBackend):
    """Optional backend intended for offline/local experimentation only."""

    name = "dots.ocr"

    def available(self) -> bool:
        return all(importlib.util.find_spec(dep) is not None for dep in ('dots_ocr',))
