"""Optional GlmOcrBackend backend stub for offline/local experimentation."""
...
class GlmOcrBackend(ExtractionBackend):
    """Optional backend intended for offline/local experimentation only."""

    name = "glm-ocr"

    def available(self) -> bool:
        return all(importlib.util.find_spec(dep) is not None for dep in ('zhipuai',))
